...
from .views import Adm, Movimentacoes, Relatorios, RotinaImovel, Usuarios, aprovarImovel, rejeitarImovel
...
urlpatterns = [
    ...
    path('administrativo/aprovar/<int:pk>/<int:historico_pk>/<int:modo>/', aprovarImovel, name='aprovar-imovel'),
    ...
    path('administrativo/relatorios', Relatorios.as_view(), name='relatorios'),
]